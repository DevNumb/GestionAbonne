...
let result2 = await fetch ("http://localhost:8000/api/sends");
    ...
    return (
      ...
      <div style={{ display: "flex", flexDirection: "column", padding:50,margin:50, backgroundColor: "white", boxShadow: "2px 2px 10px lightgray", borderRadius:"6px",position:"relative"}}>
